...
###### ###### ###### ###### ###### ###### ###### ###### ###### ###### ###### ###### ###### ###### ###### ###### 
mydata1 = read.table('/Bending_Silk/resultsFolder/ld/mydata.txt', sep="\t")
mydata2 = read.table('/Bending_Silk/resultsFolder/ebs/mydata.txt', sep="\t")
mydata3 = read.table('/Bending_Silk/resultsFolder/wb/mydata.txt', sep="\t")
mydata4 = read.table('/Bending_Silk/resultsFolder/hlw/mydata.txt', sep="\t")
mydata5 = read.table('/Bending_Silk/resultsFolder/mls/mydata.txt', sep="\t")
...
summary(x1.mlds)
png(filename="/Bending_Silk/resultsFolder/ld/ld.png");
...
summary(x2.mlds)
png(filename="/Users/wb1918a/Dropbox/Wenyan/Z_MLDS_Experiment/Bending_Silk/resultsFolder/ebs/ebs.png");
...
summary(x3.mlds)
png(filename="/Users/wb1918a/Dropbox/Wenyan/Z_MLDS_Experiment/Bending_Silk/resultsFolder/wb/wb.png");
...
summary(x4.mlds)
png(filename="/Bending_Silk/resultsFolder/hlw/hlw.png");
...
summary(x5.mlds)
png(filename="/Bending_Silk/resultsFolder/mls/mls.png");
...
png(filename="/Bending_Silk/resultsFolder/all.png");
